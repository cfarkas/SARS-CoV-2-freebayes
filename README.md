...
Assuming binaries are in ```/usr/local/bin``` , and users previously did ```samtools faidx /full/path/to/covid19-refseq.fasta```, do the following: 
...
### More examples?
please visit our wiki page here: 
